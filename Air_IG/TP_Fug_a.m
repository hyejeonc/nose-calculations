...
function Fug_struct = TP_Fug_a(T,P,Z,phase,flag_deriv)
...
[Zfac_struct, Temp]=CB_Zfac_a(T,P,Z,phase,flag_deriv);
...
if flag_deriv>0
    ...
    Fug_struct.dT=d2FdNidT+dPdNi*dPdT/(ktp1.R*T*Temp.PV)+1/T;

    % The pressure derivative of ln(Phi)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    Fug_struct.dP=-dPdNi/(ktp1.R*T*Temp.PV)-1.0/P;
    ...
    Fug_struct.dN=d2fdnidnj+(dpdni.*dpdnj)./(ktp1.R*T*Temp.PV)+1;
end