...
function Temp = CB_Deriv_a(T,P,Zfac,Temp)
...
if ktp1.EoS.m1==ktp1.EoS.m2 % Van der Waals and similar EoS    
    ...
    Temp.FFAB = -1*ktp1.EoS.m1/(ktp1.R*T*N1^2);            % N_tot^2*(d^2F/dAdB)
    ...
    Temp.FFVV=-1/V^2+1/N^2-2*Temp.a/(ktp1.R*T*N1^3);      % (1/N_tot)*(d^2F/dV^2)
